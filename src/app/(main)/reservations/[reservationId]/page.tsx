...
import { ArrowLeft, Edit3, CalendarDays, User, Phone, Mail, BedDouble, Users as UsersIconLucide, FileText, Info, Clock, CheckCircle, AlertCircle, XCircle, Hotel as HotelIcon, Bus, DollarSign, MapPin, Tag, Download } from 'lucide-react';
...
const pageTranslations = {
    en: {
      backButton: "Back to My Reservations", 
      pageTitle: "My Reservation Details",
    ...
    ar: {
      backButton: "العودة إلى حجوزاتي", 
      pageTitle: "تفاصيل حجزي",
...
const ViewReservationPage: NextPage = () => {
  ...
  const currentTranslations = useMemo(() => {
    return pageTranslations[currentLanguage] || pageTranslations.en;
  }, [currentLanguage]);
  
  const pdfEnglishTranslations = pageTranslations.en; 
  ...
  useEffect(() => {
    ...
    loadReservationData();
  }, [reservationId, router, toast, currentTranslations]);
